...
export default function Course({course}: {course: TypeCourse}){
    ...
    <CardContent className="p-6 flex flex-col flex-grow">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-50">{course.courseCode}</h2>
        <BookOpen className="h-5 w-5 text-blue-500" />
      </div>
      <h3 className="text-xl font-medium mb-2 text-gray-800 dark:text-gray-200">{course.courseName}</h3>
